...
export default class RecipeDetails extends Component {
  ...
  //   url:`https://www.food2fork.com/api/get?key=7f9e19dfd66325c64a5e90a4b7292a47&q&rId=
  //   ${this.props.id}`
  ...
  async componentDidMount(){
    ...
    const url = `https://www.food2fork.com/api/get?key=6d7b2e00cbbfff27b2fabef89f820666&q&rId=${id}`;
    console.log(url);
    try{
